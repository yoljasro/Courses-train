    ...
    <div>
      ...
      >
        ...
        <Typography variant='body1' sx={{ mb: 4 }}>
          Bu yerda Adabiyot haqida malumotlarni topishingiz mumkin. Bu yerda
        ...
        <Typography variant='body1' sx={{ mb: 4 }}>
          Bizning Adabiyot kursimiz, oquvchilarga jismoniy va fikr yoshlariga
          ...
          organasiz, jismoniy tizimlarni, shoirlar, funktsiyalarni, genetikani
          va ekologiyani tahlil qilasiz.
        </Typography>
        <Typography variant='body1' sx={{ mb: 4 }}>
          Agar siz Adabiyot haqida koproq bilim olmoqchi bolsangiz, bizning
