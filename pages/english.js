    ...
    <div>
      ...
      >
        ...
        <Typography variant='body1' sx={{ mb: 4 }}>
          Bu yerda Ingliz-tili haqida malumotlarni topishingiz mumkin. Bu yerda
        ...
        <Typography variant='body1' sx={{ mb: 4 }}>
          Bizning Ingliz-tili kursimiz, oquvchilarga jismoniy va fikr yoshlariga
        ...
        <Typography variant='body1' sx={{ mb: 4 }}>
          Agar siz Ingliz-tili haqida koproq bilim olmoqchi bolsangiz, bizning
